...
describe("UserStatus", () => {
    it("should initialize with the default status 'unconfirmed'", () => {
        ...
        expect(userStatus.getStatusString()).toBe(UserStatusEnum.unconfirmed);
    });
    ...
    it("should allow creating a new status with a specific initial value", () => {
        ...
        expect(userStatus.getStatusString()).toBe(UserStatusEnum.confirmed);
    });
    ...
    it("should allow transitioning from 'unconfirmed' to 'confirmed'", () => {
        ...
        expect(newStatus.getStatusString()).toBe(UserStatusEnum.confirmed);
        expect(userStatus.getStatusString()).toBe(UserStatusEnum.unconfirmed); // Original remains unchanged
    });
    ...
    it("should allow transitioning from 'unconfirmed' to 'suspended'", () => {
        ...
        expect(newStatus.getStatusString()).toBe(UserStatusEnum.suspended);
        expect(userStatus.getStatusString()).toBe(UserStatusEnum.unconfirmed); // Original remains unchanged
    });
    ...
    it("should allow transitioning from 'unconfirmed' to 'removed'", () => {
        ...
        expect(newStatus.getStatusString()).toBe(UserStatusEnum.removed);
        expect(userStatus.getStatusString()).toBe(UserStatusEnum.unconfirmed); // Original remains unchanged
    });
    ...
    it("should allow transitioning from 'suspended' to 'confirmed'", () => {
        ...
        const newStatus = userStatus.transitionTo(UserStatusEnum.confirmed);
        expect(newStatus.getStatusString()).toBe(UserStatusEnum.confirmed);
        expect(userStatus.getStatusString()).toBe(UserStatusEnum.suspended); // Original remains unchanged
    });
    ...
    it("should return the correct status when using getStatus()", () => {
        const userStatus = new UserStatus(UserStatusEnum.suspended);
        expect(userStatus.getStatusString()).toBe(UserStatusEnum.suspended);
    });
});