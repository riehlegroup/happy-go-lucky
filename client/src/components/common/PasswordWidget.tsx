...
const getStrengthInfo = (strength: number) => {
  switch (strength) {
    case 1:
      return { label: messages.password.strength.veryWeak, colorClass: "text-red-700" };
    case 2:
      return { label: messages.password.strength.weak, colorClass: "text-orange-600" };
    case 3:
      return { label: messages.password.strength.medium, colorClass: "text-yellow-600" };
    case 4:
      return { label: messages.password.strength.strong, colorClass: "text-green-600" };
    case 5:
      return { label: messages.password.strength.veryStrong, colorClass: "text-green-700" };
    default:
    ...
    <div className="space-y-2">
      ...
      {action === "Registration" && password !== "" && (
        <div className="flex items-center gap-2 text-sm">
          <span className="text-slate-700">{messages.password.strength.label}</span>
