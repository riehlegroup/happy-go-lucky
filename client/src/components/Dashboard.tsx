...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      <TopNavBar title={messages.dashboard.pageTitle} showBackButton={false} showUserInfo={true} />
          ...
          <div className="space-y-4">
            <Select value={selectedProject || ""} onValueChange={handleProjectChange}>
              <SelectTrigger className="w-full">
                <SelectValue placeholder={messages.dashboard.selectProjectPlaceholder} />
              </SelectTrigger>
              <SelectContent>
