...
const Standups: React.FC = () => {
  ...
  return (
    <div className="min-h-screen">
      <TopNavBar title={messages.projects.standups.pageTitle} showBackButton={true} showUserInfo={true} />
        ...
        <SectionCard title={messages.projects.standups.submitTitle}>
          <form onSubmit={handleSendStandups} className="space-y-6">
            ...
            <Textarea
              ...
              placeholder={messages.projects.standups.fields.challenges.placeholder}
