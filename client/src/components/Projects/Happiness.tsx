...
const Happiness: React.FC = (): React.ReactNode => {
  ...
  return (
    <div className="min-h-screen">
      <TopNavBar title={messages.projects.happiness.pageTitle} showBackButton={true} showUserInfo={true} />
      <div className="mx-auto max-w-6xl space-y-4 p-4">
        ...
        <TabsContent value="User">
          <SectionCard title={messages.projects.happiness.submit.sectionTitle}>
            {!nextSubmission ? (
        ...
        <TabsContent value="Display">
          <SectionCard title={messages.projects.happiness.display.sectionTitle(projectName)}>
