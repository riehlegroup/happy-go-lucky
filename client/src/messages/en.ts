export const en = {
  ...
  auth: {
    ...
    forgotPassword: {
      ...
      descriptionLine1: "Enter your email address and",
      descriptionLine2: "we will send you a link to reset your password",
      description:
    ...
    confirmEmail: {
      title: "Confirm Email",
      descriptionLine1: "Thank you for confirming your email!",
      descriptionLine2:
  ...
  settings: {
    ...
    email: {
      ...
      invalidFormatError: "Invalid email address format.",
